...
<script type="text/javascript">
    jQuery(document).ready(function ($) {
        ...
        $('#product_display_right').append($('.title-cookie'));
        $('#product_display_right').append($('.title-wrap'));
        ...
        $(".cookie-add-btn").click(function (event) {
            ...
            var c = parseInt($('.cookie-counter[num="' + num + '"]').text());
            if (c != 0){
                $(this).parents('.cookie-item').addClass('border-red');
            } else {
                $(this).parents('.cookie-item').removeClass('border-red');
            }
        });
